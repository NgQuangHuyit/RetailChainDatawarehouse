...
class UtilsTestCase(TestCase):
    ...
    def test_datafile_loading(self):
        sample_df = load_survey_df(self.spark, f"file:///opt/spark-apps/01-HelloSpark/data/sample.csv")
        result_count = sample_df.count()
        self.assertEqual(result_count, 9, "Record count should be 9")

    def test_country_count(self):
        sample_df = load_survey_df(self.spark, "file:///opt/spark-apps/01-HelloSpark/data/sample.csv")
